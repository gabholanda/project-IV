                                ...
                                <table class="table table-sm offset-md-2">
                                    ...
                                    <tbody>
                                        <c:forEach items="${entregaAttr}" var="entrega">
                                            <tr>
                                                <th> <c:out value="${entrega.getId()}"/></th>
                                                <td ><c:out value="${entrega.getCep()}"/></td>
                                                <td><c:out value="${entrega.getRua()}"/></td>
                                                <td> <c:out value="${entrega.getNumero()}"/></td>
                                                <td> <c:out value="${entrega.getComplemento()}"/></td>
                                                <td> <c:out value="${entrega.getBairro()}"/></td>
                                                <td> <c:out value="${entrega.getCidade()}"/></td>
                                                <td> <c:out value="${entrega.getEstado()}"/></td>
                                                <td> <c:out value="${entrega.getTipo()}"/></td>
                                                <td><a data-method="get" href="${pageContext.request.contextPath}/listar-enderecos?id=${produto.getId()}" class="btn btn-primary mb-1" >Usar Endereço</a></td>
                                                <td><a data-method="get" href="${pageContext.request.contextPath}/enderecos?id=${produto.getIdCliente()}" class="btn btn-primary mb-1" >Cadastrar Endereços</a></td>
                                            </tr>
                                        </c:forEach>
                                </table>
                            </div>
