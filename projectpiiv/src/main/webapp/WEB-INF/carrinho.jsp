            ...
            <div class="row">
                <div class="span9">
                                ...
                                <c:forEach items="${produtosAttr}" var="produto">
                                    <tr>
                                        ...
                                        <td><input type="text" placeholder="1" class="input-mini" id="qtdProduto"
                                                min="0" data-bind="qtdProduto" onClick=""
                                                value="${produto.getQuantidade()}"></td>
                                        <td> <input type="text" class="input-mini" id="preco" data-bind="preco"
                                                value="${produto.getProduto().getPreco()}">
                                        </td>
                                        <td><input type="text" class="input-mini" id="totalProd" data-bind="totalProd"
                                                value="${produto.vlrTotalItem()}" />
                                        </td>
                                    </tr>
                    ...
                    <tr>
                        ...
                        <td>&nbsp;</td>
                        <td><strong>R$
                                <input type="text" placeholder="1" class="input-mini" name="total" id="total" min="0"
                                    data-bind="total" value="${totalAttr}" /></strong></td>
                    </tr>
                    </tbody>
                    </table>
                    ...
                    <c:if test="${not empty produtosAttr}">
                        ...
                        <form class="form-inline" method="get"
                            action="${pageContext.request.contextPath}/continuarVenda">
        ...
        function sum() {
            ...
            for (var i = 0; i < preco.length; i++) {
                ...
                if (!isNaN(totalProduto)) {
                    document.getElementById('totalProd'[i]).innerHTML = totalProduto;
