...
<html lang="pt-br">
    ...
    <body>
        ...
        <form action="${pageContext.request.contextPath}/estoquista/atualizar-quantidade" method="post" novalidate>
            <input type="hidden" name="id" value="${idAttr}">
             
            <div class="form-group row">
                <label for="inputNome" class="col-sm-1 offset-md-3">Nome*:</label>
                <input type="text" value="${nomeAttr}" class="form-control col-md-4" name="nome" id="nome" disabled>
            </div>

            <div class="form-group row">
                <label for="inputDesc" class="col-sm-1 offset-md-3">Descrição</label>
                <textarea class="form-control col-sm-4" id="inputDesc" name="descricao" rows="3" disabled>${descricaoAttr}</textarea>
            </div>
            
            <div class="form-group row">
                <label for="inputTipo" class="col-sm-1 offset-md-3" disabled>Tipo*:</label>

                <select name="tipo" id="tipo" class="form-control col-sm-4" disabled>
            ...
            <div class="form-group row">
                ...
                <input value="${precoAttr}" type="number" class="form-control col-sm-4" name="preco" id="inputPreco" disabled>
            </div>
            ...
            <br>
             <div class="button-group">
                <button class="btn  btn-success offset-md-5" type="submit">Atualizar</button>
                &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
