...
<html lang="pt-br">
    ...
    <body>
        ...
        <c:if test="${excluirAttr}">
            <div class="alert alert-success">
                Usuário excluído com sucesso!
            </div>
        </c:if>

        <c:if test="${not empty funcionariosAttr}">
            <table class="table table-sm offset-md-2" style="width: 75%;">
                ...
                <tbody>
                    <c:forEach items="${funcionariosAttr}" var="funcionario">
                        <tr>
                            <th> <c:out value="${funcionario.getIdUser()}"/></th>
                        ...
                        <div class="modal-dialog" role="document">
                            <div class="modal-content">
                                <div class="modal-body">
                                    Tem certeza que deseja excluir o usuario <c:out value="${funcionario.getNome()}}"/>
                                </div>
                                <div class="modal-footer">
                                    <form action="${pageContext.request.contextPath}/admin/excluir-usuario" method="post">
                                        <button class="btn btn-success" type="submit" name="id" id="confirmDeleteButton" value="${funcionario.getIdUser()}">Confirmar</button>
                                    </form>
