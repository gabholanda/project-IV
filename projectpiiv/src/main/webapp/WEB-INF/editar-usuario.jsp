...
<body>
    ...
    <form method="post" action="${pageContext.request.contextPath}/admin/editar-usuario" novalidate> 
        <input type="hidden" name="id" value="${idAttr}">
        <br>
        <div class="form-group row">
            <label for="inputNome" class="col-sm-1 offset-md-3">Nome*:</label>
            <input type="text" value="${nomeAttr}" class="form-control col-md-4" name="nome" id="nome" placeholder="Digite o nome do Usuario" required>
        ...
        <div class="form-group row">
            ...
            <input type="password" value="${senhaAttr}" class="form-control col-md-4" name="senha" id="senha" placeholder="Digite a senha do Usuario" required>
            <div class="invalid-feedback">
